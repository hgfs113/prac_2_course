...
{    
    ...
    s[2]='c';
    s[3]='\0';
    student st(1,2,s),s1,s2(st);
    _class1 cl;
    cl.addst(st);
    std::cout <<"cl\n"<<cl <<'\n';
    _class1 cl2 = _class1(cl);
    cl2.addst(s2);
    cl2.addst(s1);
    cl = cl2;
    const _class1 cl_const(cl2);
    cl2 = cl_const;
    std::cout <<"cl.getnumber "<<cl.getnumber() <<'\n';
    std::cout <<"cl_const.getnumber "<<cl.getnumber() <<'\n';
    std::cout <<"cl\n"<<cl <<'\n';
    std::cout <<"cl2\n"<<cl2<<'\n';
    std::cout <<"cl_const\n"<<cl_const<<'\n';
    std::cout <<"_class::Nums() = "<<_class::Nums() <<'\n';
    std::cout <<"cl[0]\t"<<cl[0]<<'\n';
    std::cout <<"cl2[1]\t"<<cl2[1]<<'\n';
    std::cout <<"cl_const[2]\t"<<cl_const[2]<<'\n';
    return 0;
}
